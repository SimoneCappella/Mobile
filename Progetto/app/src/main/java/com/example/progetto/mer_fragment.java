...
/**
 * Classe che gestisce visualizzazione, salvataggio e caricamento di materie aula e orari del mercoledì.
 */
public class mer_fragment extends Fragment implements View.OnClickListener {
    ...
    /**
     * La stringa q sarà del tipo: "mer_1; mer_2; ... ; mer_11", questa viene usata come chiave per salvare nelle shared preferences la materia e assegnarla alla textView giusta.
