...
/**
 * Classe che gestisce visualizzazione, salvataggio e caricamento di materie aula e orari del giovedì.
 */
public class gio_fragment extends Fragment implements View.OnClickListener {

    private DataManager dm;
    public static final int REQUEST_CODE = 0000;
    private SalvaOrario sa;
    ...
    String ora, materia, aula, i="gio_";
    int n, inc;
    ...
    public void launchList(){
        ...
        intent.putExtra("giorno_ora", "giovedì  " + ora);
    ...
    /**
     * La stringa q sarà del tipo: "gio_1; gio_2; ... ; gio_11", questa viene usata come chiave per salvare nelle shared preferences la materia e assegnarla alla textView giusta.
