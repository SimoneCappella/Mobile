...
/**
 * Classe che gestisce visualizzazione, salvataggio e caricamento di materie aula e orari del martedì.
 */
public class mar_fragment extends Fragment implements View.OnClickListener {
    ...
    public void launchList(){
        ...
        intent.putExtra("giorno_ora", "martedì  " + ora);
    ...
    /**
     * La stringa q sarà del tipo: "mar_1; mar_2; ... ; mar_11", questa viene usata come chiave per salvare nelle shared preferences la materia e assegnarla alla textView giusta.
